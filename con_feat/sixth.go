//6. Multiple Producer Multiple Consumer
// Use case
//  ----Many goroutines produce jobs, many goroutines consume jobs.
...
Pros
	...
	Good for task pipelines

Cons
	Need correct channel closing

	Debugging ordering is harder
*/
